const PaintDetails = ({ paints }) => {
    ...
    return (
        <div className="w-full">
            <div className="text-center paint-details max-w-sm p-6 bg-[#003058] rounded-lg shadow hover:border-[#003058] hover:bg-[#ba1c21] dark:border-[#ba1c21] dark:hover:bg-[#ba1c21] border-2 border-white w-full hover:text-[#003058] text-[#ba1c21]">
